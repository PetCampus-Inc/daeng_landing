...
const Header = () => {
  return (
    <header className='fixed top-0 flex w-full justify-between border border-line_gray px-3 py-3 sm:px-10 sm:py-4 md:px-20 md:py-5 lg:px-30 lg:py-6 xl:px-50 xl:py-7 2xl:px-[300px]'>
